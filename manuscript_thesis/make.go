...
func main() {
	...
	copyFillup.In("origplot").Connect(spc.NewFileSource(wf, "origplot", "../exp/20171123-fillup/res/final_models_summary.sorted.tsv.plot.pdf").Out())
	copyFillup.SetPathStatic("fillup_plot", "figures/allmodels_fillup.pdf")
