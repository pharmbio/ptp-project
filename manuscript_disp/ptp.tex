...
The resulting set consists of 31 targets, identified by the following gene
...
this target, thus being ``assumed non-active''. The amount of such assumed
non-active compounds were chosen such that the total number of non-actives and
assumed non-actives would be twice the number of actives, for each target
respectively (See \href{https://github.com/pharmbio/ptp-project/blob/c529cf307593c40e7f822a92b224036894c95de1/exp/20180426-wo-drugbank/wo_drugbank_wf.go#L308-L328}{here} for workflow code).
...
``class-normalized
observed fuzziness'' (CNOF\todo{Jonathan and Staffan will look further at this equation}) as
...
\end{equation}
where $p_i^y$ is the p-value of the $i^{th}$ test case for class $y$, and $m_A$
is the number of test examples for class active and $m_N$ is the number of test
examples for class non-active.
...
\todo{Present a few (1-3) calibration plots in the main manuscript and refer to them here as 'illustrative'. They constitute hard results.}
...
\begin{figure}[h!]
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/ache_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/adora2a_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/adrb1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/adrb2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/ar_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/avpr1a_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/cckar_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/chrm1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/chrm2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/chrm3_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/cnr1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/cnr2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/drd1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/drd2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/ednra_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/htr1a_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/htr2a_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/kcnh2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/lck_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/maoa_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/nr3c1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/oprd1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/oprk1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/oprm1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/pde3a_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/ptgs1_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/ptgs2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/scn5a_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/slc6a2_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/slc6a3_calib.pdf}
\includegraphics[width=0.3\textwidth]{figures/calibration_plots/slc6a4_calib.pdf}
