...
predictor must accepts less probable (in the Conformal Prediction ranking sense) 
...
has to include less likely predictions for it not to miss any true labels, leading 
