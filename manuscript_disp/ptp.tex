...
Efficiency metrics (OF and CNOF) for all models before fill up with assumed non-actives is shown in figure~\ref{fig:allmodels_nofillup}. In figure
...
ExcapeDB. We observe that by adding assumed non-actives for small, imbalanced datasets we improve the efficiency of models trained on these datasets. This strategy was chosen for the remaining analysis workflows.
In the next step, data from 
