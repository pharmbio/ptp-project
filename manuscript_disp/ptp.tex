...
We present an approach for ligand-based target profiling using a
...
studies~\cite{lapins2018confidence} and for ligand-based target prediction~\cite{alvarsson2014ligand}. Support vector machines is a machine learning
...
As an initial sanity check, that our training procedure works as expected, we
generated calibration plots in the cross-validation step of our workflow. Three
...
found in the supplemental material, in figure \ref{fig:calibration_plots_all}.
