...
be predicted to a specific label with the higher confidence level.
...
\inlinetodo{I have added one explanation now ... but I have a harder time
explaining the ``None'' prediction ... gotta check Norinder's paper}
