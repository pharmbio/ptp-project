...
\includegraphics[width=0.19\textwidth]{figures/validation_plots/slc6a4_valplot.pdf}
    ...
    labels (None, Active (A), Non-active (N) or Both). Dark grey in the stacked
    bar plot means the original label was Active (A), while light grey means
    the original label was Non-Active (N).}
    \label{fig:validation_plots_all}
\end{figure}
