...
Chemicals were represented by the signature molecular descriptor and we used
support vector machines as the underlying machine learning method. With
conformal prediction, results from predictions are in the form of confidence
p-values for the different classes.  The full pre-processing and model training
...
or categorial) are described numerically be descriptors and a statistical
