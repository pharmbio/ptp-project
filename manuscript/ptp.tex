...
and targets, was ExcapeDB~\texttt{\color{magenta}ADD REF!}. An extraction of only the columns for Gene name,
...
rows for which there were rows with a conflicting value for the activity
...
\todoil{Let's make a table out of this! including number of negatives and
