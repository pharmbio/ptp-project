...
active and non-active in ExcapeDB. The labels `included' and `not included'
...
association between ligands and targets from the ExcapeDB
...
ExcapeDB data file (18 GB). From the extracted dataset, all rows for which
...
For full information about the preprocessing done by the ExcapeDB authors to
