...
accessible at
\url{http://ptp.os.pharmb.io/}\todo{why not \url{http://ptp.services.pharmb.io/}}
...
\textit{confidence}\todo{credibility?} of a prediction is defined as 1-`lowest p-value' \cite{Vovk2005}
