...
-- in the ExCAPE-DB dataset -- set to active (or \texttt{A}) if the
dose-response value in the binding assays was lower than 10 ${\mu}M$ and
non-active (or \texttt{N}) otherwise.
...
ensures `strange' chemistry in the additional assumed non-active compounds
