...
(classification). The recent increase in the number of available SAR data points
...
methodology (CP)~\cite{Vovk2005}, which has been successfully demonstrated in
several recent
studies~\cite{Cortes-Ciriano:2015ec,Norinder:2014fe,Forreryd:2018kb,Norinder:2016qf}.
For an introduction to CP, we refer the reader to~\cite{Gammerman2007}, and
for an introduction to CP in cheminformatics, we refer the user
to~\cite{Norinder:2014fe}.
%
