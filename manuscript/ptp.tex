...
for Gene name, SMILES and Activity flag was performed in order to make
subsequent data transformation steps easier to implement and faster to
process, given the relative large size of the uncompressed ExcapeDB data file
(18 GB).
