...
Staffans suggestion: For the classification case a prediction is given as set of conformal p-values, one for each class,
...
documentation~\cite{CPSignDocs}. \todo{Extend on why}
