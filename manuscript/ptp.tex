...
This indicates a somewhat higher specificity than sensitivity, generally for
all targets. We want to highlight to the reader though that the definition of
specificity and sensitivity is not as clear-cut in the conformal prediction
setting, as we are having four sets of labels for a binary classification
setting (``None'' and ``Both'', in addition to the prediction labels), rather
than just two.
