...
used for comparing efficiency metrics when adding assumed non-actives, versus
when not adding them. More detailed workflow graphs are available in the supplemental
