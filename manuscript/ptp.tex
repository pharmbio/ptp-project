...
\includegraphics[width=0.63\textwidth]{figures/fig1_schematic_workflow.pdf}
    ...
    detailed workflow plots, see the supplemental material, figures 4 and 5.}
...
available in the supplemental material (figure~4 and 5).
...
found in the supplemental material (figure~1).
...
individually, see the supplemental material, figure 2 and 3.
...
\end{minipage}
    ...
    the supplemental material, figure 2 and 3.}
    \label{fig:valplots}
\end{figure}
