...
\inlinetodo{Ola does not like the term 'fill up', can we not simply say adding
...
\begin{figure}
    \begin{minipage}{0.70\textwidth}
        ...
        \subcaption{The profile as it looks on the web page. The user draws a molecule, selects a confidence and then the profile updates underneath.}
        \label{fig:terbutaline:a}
    \end{minipage}
    \quad
    \begin{minipage}{0.25\textwidth}
        \fbox{\includegraphics[height=0.23\textheight]{figures/terbutaline2.png}}
        \subcaption{Coloring of which parts of the molecule contributed the most to the prediction for ADBR2.}
...
created for three molecules from the test set (figure~\ref{fig:terbutaline},
...
\begin{minipage}[t]{0.3\textwidth}
    ...
    \subcaption{The profile for Tacrine, a centrally acting anticholinesterase, with a distinct peak for the ACHE gene.}
...
\begin{minipage}[t]{0.3\textwidth}
    ...
    receptor M$_1$ agonist, with two higher peaks, CHRM1 and LCK, only CHRM1
    has a really low p-value for non-active though (0.001).}
...
\begin{minipage}[t]{0.3\textwidth}
    ...
    agonist. This can be seen in the profile as these four genes have the four
    highest p-values for active.}
...
\FloatBarrier
\section*{Conclusion}
\inlinetodo{This versions needs a conclusion though}
