...
- @samuell to start writing down the methods section of the paper (in the
  repo), and explaining in words what the workflow does, so as to allow review
  of these parts by others in the project.
- @samuell also to create summaries over the 44 targets/models ... stuff like:
...
- @olas to send list of Conformal Prediction papers to @samuell
